...
class swerveh1(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","swerveh1")
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       self.hexgen_cmd = 'riscv32-unknown-elf-objcopy -O verilog  my.elf my.hex'
        
        # runs only once
       build_swerveh1 = 'cd $RV_ROOT \n \
       make -f ./tools/Makefile'

    #    utils.shellCommand(build_swerveh1).run()   
       # verilator run test
       self.sigdump_cmd = 'cd $RV_ROOT \n \
       ./obj_dir/Vtb_top +SIGFILE={0} +CODEFILE={1}/my.hex'
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for swerveh1 start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
